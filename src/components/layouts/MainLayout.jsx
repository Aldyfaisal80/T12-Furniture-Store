...
export default function MainLayout() {
  return (
    <div className="flex flex-col w-full px-[80px] gap-[80px]">
        {/* section 1 */}
        <div className="flex flex-col w-full h-screen border-2 border-primary-gray">
            <Navbar />
        ...
        {/* section 2 */}
        <div className="flex flex-col w-full h-screen bg-primary-blue border-2 border-primary-gray">
            <Section2 />
        </div>
